      ...
      <div className="flex flex-col lg:flex-row items-center gap-20">
        ...
        <div className="lg:w-7/12">
          ...
          <div className="space-y-6 text-gray-600 text-lg leading-relaxed mb-10">
            <p>
              Looking for the best pest control in AP & Telangana? Your search ends at **starpestcontrol.in**, your trusted portal for booking nearby pest control services. We ensure a pest-free home by tackling rats, cockroaches, mosquitos, spiders, and more.
            </p>
          ...
          <div className="flex flex-wrap gap-6 pt-4">
            ...
            <div className="flex items-center gap-4">
               <div className="w-16 h-16 rounded-2xl bg-white p-2 shadow-lg border border-gray-100">
                  <img src="/assets/spc-logo.png" className="w-full h-full object-contain" alt="Logo mini" />
               </div>
               <div>
                  <p className="font-bold text-brand-purple leading-none">Trust Star PC</p>
